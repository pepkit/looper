...
Pipeline interfaces are defined in the looper config file (e.g. `.looper.yaml`):
...
- `schema_path` (RECOMMENDED| REQUIRED FOR PIPESTAT) - A schema describing the *outputs* of the pipeline.
