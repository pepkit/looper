...
class TopLevelParser(pydantic.BaseModel):
    ...
    sample_pipeline_interfaces: Optional[list[str]] = ArgumentEnum.SAMPLE_PIPELINE_INTERFACES.value.with_reduced_default()
    project_pipeline_interfaces: Optional[list[str]] = ArgumentEnum.PROJECT_PIPELINE_INTERFACES.value.with_reduced_default()
